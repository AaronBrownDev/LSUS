...
public class TestMain {
    public static void main(String[] args) {
        IPersonalFinance pf = PersonalFinanceApp.getInstance();
    ...
    private static void testDebit(IPersonalFinance pf, ArrayList<Test> tests) {
        ...
        //Always returns true b/c "Amex" is always added if pf is correct
        //results in failure b/c expected value is false
        //change to !pf.addDebitAccount("Amex", 123.45)
        tests.add(new Test(
        ...
        //always fails/returns false b/c Amex account is added earlier and not tested for
        //therefore m will always = false so "return rc && m" will always return false
        ...
        //Amex added earlier is used to test for changing account name to a non-unique name
        //Change Amex to Chase Checking

        tests.add(new Test(
                "Trying to change the debit account's name to a null or non-unique name is unsuccessful",
                () -> pf.updateDebitAccountName("Red River", "Chase Checking") ||
        ...
        //"Amex" account not tested for again so m will always = false
        //therefore "return rc && m" always returns false
        tests.add(new Test(
    ...
    private static void testBudget(IPersonalFinance pf, ArrayList<Test> tests) {
        ...
        tests.add(new Test(
                ...
                () -> {
                    return pf.removeBudget("Dec 2024");
                },
                false
        ));
        tests.add(new Test(
                ...
                () -> {
                    try {
                        return pf.updateBudgetName("Dec 2024", "Dec '24") ||
                                pf.updateBudgetStartDate("Dec 2024", DateFormat.getDateInstance().parse("Dec 1, 2024")) ||
                                pf.updateBudgetEndDate("Dec 2024", DateFormat.getDateInstance().parse("Dec 31, 2024")) ||
                                pf.addOrUpdateBudgetItem("Dec 2024", "Rent", 1000.00);
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc =  pf.addBudget("Dec 2024",
                                DateFormat.getDateInstance().parse("Dec 1, 2024"),
                                DateFormat.getDateInstance().parse("Dec 31, 2024"),
                                null);
                        rc = rc && pf.addBudget("Jan 2025",
                                DateFormat.getDateInstance().parse("Jan 1, 2025"),
                                DateFormat.getDateInstance().parse("Jan 30, 2025"),
                                new HashMap<>());
                        rc = rc && pf.getCategories().size() == 3;
                        Iterator<IBudget> iterator = pf.getBudgets().iterator();
                        IBudget b = iterator.next();
                        rc = rc && b.getName().equals("Dec 2024") &&
                                b.getStartDate().compareTo(DateFormat.getDateInstance().parse("Dec 1, 2024")) == 0 &&
                                b.getEndDate().compareTo(DateFormat.getDateInstance().parse("Dec 31, 2024")) == 0 &&
                                b.getItems().isEmpty();
                        b = iterator.next();
                        rc = rc && b.getName().equals("Jan 2025") &&
                                b.getStartDate().compareTo(DateFormat.getDateInstance().parse("Jan 1, 2025")) == 0 &&
                                b.getEndDate().compareTo(DateFormat.getDateInstance().parse("Jan 30, 2025")) == 0 &&
                                b.getItems().isEmpty();
                        return rc;
                    } catch (ParseException e) {
                        e.printStackTrace();
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        return pf.addBudget("April 2024",
                                null,
                                DateFormat.getDateInstance().parse("April 30, 2024"),
                                null) ||
                                pf.addBudget("April 2024",
                                        DateFormat.getDateInstance().parse("April 30, 2024"),
                                        DateFormat.getDateInstance().parse("April 1, 2024"),
                                        null) ||
                                pf.addBudget("April 2024",
                                        DateFormat.getDateInstance().parse("April 1, 2024"),
                                        null,
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    try {
                        ...
                        rc[0] = true;
                        rc[1] = pf.addBudget("April 2024",
                                DateFormat.getDateInstance().parse("April 1, 2024"),
                                DateFormat.getDateInstance().parse("April 30, 2024"),
                                items);
                        rc[2] = pf.getBudgets().size() == 3;
                        for (IBudget b: pf.getBudgets()) {
                            if (b.getName().equals("Dec 2024") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("Dec 1, 2024")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("Dec 31, 2024")) == 0 &&
                                    b.getItems().isEmpty())
                                rc[3] = true;
                            else if (b.getName().equals("June 2024") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("June 1, 2024")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("June 30, 2024")) == 0 &&
                                    b.getItems().isEmpty())
                                rc[4] = true;
                            else if (b.getName().equals("April 2024") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("April 1, 2024")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("April 30, 2024")) == 0 &&
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    try {
                        ...
                        rc[0] = true;
                        rc[1] = pf.addBudget("March 2024",
                                DateFormat.getDateInstance().parse("March 1, 2024"),
                                DateFormat.getDateInstance().parse("March 31, 2024"),
                                items);
                        items.put("Paycheck", 2200.00);
                        items.put("Rent", 520.00);
                        items.put("Groceries", 220.00);
                        rc[2] = pf.addBudget("February 2024",
                                DateFormat.getDateInstance().parse("February 1, 2024"),
                                DateFormat.getDateInstance().parse("February 28, 2024"),
                                items);
                        ...
                        for (IBudget b: pf.getBudgets()) {
                            if (b.getName().equals("Dec 2024") &&
                                ...
                                rc[5] = true;
                                    ...
                                    b.getItems().get(map.get("Groceries")) == 200.00)
                                rc[6] = true;
                            else if (b.getName().equals("March 2024") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("March 1, 2024")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("March 31, 2024")) == 0 &&
                                    b.getItems().get(map.get("Paycheck")) == 2100.00 &&
                                    b.getItems().get(map.get("Rent")) == 510.00 &&
                                    b.getItems().get(map.get("Groceries")) == 210.00)
                                rc[7] = true;
                            else if (b.getName().equals("February 2024") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("February 1, 2024")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("February 28, 2024")) == 0 &&
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    for (ICategory c: categories)
                        map.put(c.getName(), c);
                    boolean rc = pf.removeBudget("February 2024");
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    for (ICategory c: categories)
                        map.put(c.getName(), c);
                    boolean rc = !pf.removeBudget("Dec '21");
        ...
        tests.add(new Test(
                ...
                () -> {
                    boolean rc = pf.updateBudgetName("Dec 2024", "Dec '21");
                    rc = rc && pf.getBudgets().size() == 4;
                    Map<String, ICategory> map = new HashMap<>();
                    Collection<ICategory> categories = pf.getCategories();
                    for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetName("Jan 2024", "January 2024") &&
                                !pf.updateBudgetStartDate("Jan 2024", DateFormat.getDateInstance().parse("Jan 1, 2024")) &&
                                !pf.updateBudgetEndDate("Jan 2024", DateFormat.getDateInstance().parse("Jan 31, 2024")) &&
                                !pf.addOrUpdateBudgetItem("Jan 2024", "Rent", 1200.0);
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetName("June 2024", "April 2024") &&
                                !pf.updateBudgetName("Dec' 21", null);
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.updateBudgetStartDate("June 2024", DateFormat.getDateInstance().parse("June 2, 2024")) &&
                                pf.updateBudgetEndDate("Dec '21", DateFormat.getDateInstance().parse("Dec 29, 2024"));
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
                        ...
                        for (IBudget b: pf.getBudgets()) {
                            if (b.getName().equals("Dec '21") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("Dec 1, 2024")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("Dec 29, 2024")) == 0 &&
                                    b.getItems().isEmpty()) {
                            }
                            else if (b.getName().equals("June 2024") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("June 2, 2024")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("June 30, 2024")) == 0 &&
                                    b.getItems().isEmpty()) {
                            }
                            else if (b.getName().equals("April 2024") &&
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetStartDate("June 2024", null) &&
                                !pf.updateBudgetStartDate("Dec '21", DateFormat.getDateInstance().parse("June 29, 2024"));
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetEndDate("June 2024", null) &&
                                !pf.updateBudgetEndDate("Dec '21", DateFormat.getDateInstance().parse("April 30, 2024"));
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.addOrUpdateBudgetItem("Dec '21", "Rent", 1200.0) &&
                                pf.addOrUpdateBudgetItem("April 2024", "Rent", 600);
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.addOrUpdateBudgetItem("Dec '21", null, 1300.0) &&
                                !pf.addOrUpdateBudgetItem("April 2024", "Leccy", 700);
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.addOrUpdateBudgetItem("Dec '21", "Rent", -1300.0);
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.removeBudgetItem("Dec '21", "Rent");
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
    ...
    private static void testTransaction(IPersonalFinance pf, ArrayList<Test> tests) {
        ...
        tests.add(new Test(
                ...
                ()-> {
                    try {
                        return pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2024"),
                                DateFormat.getDateInstance().parse("March 31, 2024")).size();
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return -1;
                    }
        ...
        tests.add(new ExceptionTest(
                ...
                ()-> {
                    try {
                        return pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2024"),
                                DateFormat.getDateInstance().parse("March 1, 2024")).add(null);
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return true;
                    }
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc =  pf.getTransactions(DateFormat.getDateInstance().parse("March 31, 2024"),
                                DateFormat.getDateInstance().parse("March 1, 2024")).isEmpty();
                        rc = rc && pf.getTransactions(null, DateFormat.getDateInstance().parse("March 1, 2024")).isEmpty();
                        rc = rc && pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2024"), null).isEmpty();
                        return rc;
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return false;
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        ...
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("August 1, 2026"),
                                "Kroger", 50.0, "Groceries", "Amex") == -1;
                        rc = rc && pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2020"),
                                DateFormat.getDateInstance().parse("March 31, 2024")).size() == 0;
                        return rc;
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return false;
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.addTransaction(DateFormat.getDateInstance().parse("March 1, 2024"),
                                "", 50.0, "Groceries", "Amex") == -1;
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("March 1, 2024"),
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        ...
                        rc = rc && pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2020"),
                                DateFormat.getDateInstance().parse("March 31, 2024")).size() == 1;
                        return rc;
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return false;
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.addTransaction(DateFormat.getDateInstance().parse("March 2, 2024"),
                                "Whole Foods", 75.0, "Groceries", "Amex") == 1;
                        rc = rc && pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2020"),
                                DateFormat.getDateInstance().parse("March 31, 2024")).size() == 2;
                        return rc;
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return false;
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.addTransaction(DateFormat.getDateInstance().parse("March 15, 2024"),
                                "LSUS PPD", 2000.0, "Paycheck", "CFCU") == 2;
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("April 1, 2024"),
                        ...
                        for (ITransaction i: transactions) {
                            if (i.getId() == 0) {
                                ...
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 1, 2024")) == 0;
                                ...
                                rc = rc && i.getCategory().getName().equals("Groceries");
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 2, 2024")) == 0;
                                ...
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 15, 2024")) == 0;
                                ...
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("April 1, 2024")) == 0;
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        ...
                        rc = rc && !pf.updateTransactionDate(6, DateFormat.getDateInstance().parse("March 31, 2024"));
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        ...
                        rc = rc && !pf.updateTransactionDate(1, DateFormat.getDateInstance().parse("August 31, 2024"));
                        Collection<ITransaction> transactions = pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2020"),
                                DateFormat.getDateInstance().parse("March 31, 2024"));
                        rc = rc && transactions.size() == 3;
                        for (ITransaction i: transactions) {
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.updateTransactionDate(2, DateFormat.getDateInstance().parse("March 21, 2024"));
                        Collection<ITransaction> transactions = pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2020"),
                                DateFormat.getDateInstance().parse("March 31, 2024"));
                        rc = rc && transactions.size() == 3;
                        for (ITransaction i: transactions) {
                            if (i.getId() == 1) {
                                ...
                                rc = rc && i.getAmount() == 2000.0;
                                rc = rc && i.getCategory().getName().equals("Paycheck");
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 21, 2024")) == 0;
                                rc = rc && i.getDescription().equals("LSUS PPD");
                            }
                            else if (i.getId() == 3) {
                                rc = rc && i.getAccount().getName().equals("CFCU");
...
//                        else rc = false;
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    boolean rc = true;
                    try {
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("March 2, 2024"),
                                "Interest", 2.0, "Interest due", ac1.getName()) == 5;
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("March 2, 2024"),
                                "Interest", 2.0, "Interest income", ac2.getName()) == 6;
                    } catch (ParseException e) {
                        e.printStackTrace();
                    }
